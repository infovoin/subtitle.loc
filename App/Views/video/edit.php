...
<div class="container">
    ...
    <div id="step1-1" class="jumbotron">
        ...
        <ul class="text-left">
            ...
            <input type="text" id="video_title" class="form-control" value="<?php echo $video->video_name ?>"
        ...
        <ol class="text-left">
            ...
            <div id="div_for_path_to_video_file" class="">
                ...
                <input type="text" id="path_to_video_file" class="form-control" placeholder="http://..."
                       value="<?php echo $video->path_to_file ?>">
...
"><?php echo $video->original_eng_sub ?></textarea></li>
            <br>
            <li>
    ...
    <hr>
    <div align="center">
        <?php echo $video->video_name ?><br>
        <button id="delete_video" type="button" class="btn btn-danger ">Удалить видео</button>
        <p>Внимание будут так же удалены все "слова" "фразы" и "отложенные на рассмотрения" поэтому подумайте а стоит ли удалять?</p>
    </div>
